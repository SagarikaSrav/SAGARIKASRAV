...
path_to_csv = 'C:/Users/SAGARIKA/Downloads/data (2).csv'
import warnings
...
titanic = pd.read_csv("C:/Users/SAGARIKA/Desktop/train.csv")
print(titanic)
...
glass = pd.read_csv("C:/Users/SAGARIKA/Desktop/glass.csv")
